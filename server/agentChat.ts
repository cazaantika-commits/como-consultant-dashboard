...
2. اعرض كل الملفات في المجلد بـ list_drive_files
3. اقرأ كل ملف متاح (لا تتوقف عند ملفين فقط!):
   ...
   - NOC → شروط عدم ممانعة
4. ❗ مهم: اقرأ كل ملف PDF بـ read_drive_file_content - لا تتخطى أي ملف!
...
7. أبلغ المالك بتقرير مفصل: عدد الملفات المقروءة، الحقول المعبأة، الحقول الناقصة مع السبب
