...
export default function CostsCashFlowTab({ projectId, studyId }: CostsCashFlowTabProps) {
  ...
  const allCostItems = [
    ...
    { label: "أتعاب الاستشاري — التصاميم", value: costs.designFee, note: `${costs.designFeePct}%` },
    { label: "أتعاب الاستشاري — الإشراف", value: costs.supervisionFee, note: `${costs.supervisionFeePct}%` },
