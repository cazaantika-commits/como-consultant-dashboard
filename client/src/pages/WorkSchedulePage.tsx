             ...
             <div className="w-8 text-center border-l border-cyan-500/40 h-full flex items-center justify-center text-[10px]">WBS</div>
              ...
              {!compactMode && (
                <>
                  ...
                  <div className="w-28 text-center border-l border-cyan-500/40 h-full flex items-center justify-center text-[10px]">البدء</div>
                  <div className="w-28 text-center border-l border-cyan-500/40 h-full flex items-center justify-center text-[10px]">الانتهاء</div>
            ...
            {filteredRows.map((row, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Start date */}
                  <div
                    className={`w-28 text-center text-[9px] border-l border-gray-100 whitespace-nowrap ${!isStage && !editingRow ? "cursor-pointer hover:bg-blue-50" : ""} ${editingRow === row.serviceCode ? "p-0" : "text-gray-600"}`}
                  ...
                  <div
                    className={`w-28 text-center text-[9px] border-l border-gray-100 whitespace-nowrap ${editingRow === row.serviceCode ? "p-0 bg-gray-50" : "text-gray-600"}`}
                  >
                    {editingRow === row.serviceCode ? (
