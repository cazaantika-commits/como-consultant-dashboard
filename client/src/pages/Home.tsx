            ...
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {[
                  ...
                  { label: "مراحل التطوير", emoji: "🏗️", icon: Layers, path: "/development-stages", gradient: "linear-gradient(135deg, #8b5cf6, #7c3aed)", shadow: "rgba(139, 92, 246, 0.25)" },
                  { label: "التدفق النقدي", emoji: "💰", icon: TrendingUp, path: "/cash-flow", gradient: "linear-gradient(135deg, #10b981, #059669)", shadow: "rgba(16, 185, 129, 0.25)" },
                  { label: "دورة المشروع", emoji: "♻️", icon: Activity, path: "/project-lifecycle", gradient: "linear-gradient(135deg, #f59e0b, #d97706)", shadow: "rgba(245, 158, 11, 0.25)" },
