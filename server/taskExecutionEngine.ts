...
const AGENT_READ_CAPABILITIES: Record<AgentType, string[]> = {
  salwa: ["list_projects", "list_consultants", "get_project_consultants", "get_evaluation_scores", "get_financial_data", "list_tasks", "get_consultant_profile", "get_committee_decision", "get_evaluator_scores", "get_feasibility_study", "list_meetings", "get_meeting_details", "get_meeting_tasks_status", "search_all_data", "query_institutional_memory"],
  farouq: ["list_projects", "list_consultants", "get_project_consultants", "get_evaluation_scores", "get_evaluator_scores", "get_financial_data", "get_evaluation_criteria", "get_consultant_profile", "get_committee_decision", "list_meetings", "get_meeting_details", "query_institutional_memory"],
