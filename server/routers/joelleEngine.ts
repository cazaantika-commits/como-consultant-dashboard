    ...
    .mutation(async ({ ctx, input: projectId }) => {
      ...
      try {
        ...
        if (nearbyProjects.length === 0) {
          ...
          throw new Error(`فشل في محرك المنافسين: لا توجد بيانات حقيقية من Google Maps للمنطقة ${factSheet.community}`);
        }
...
- **تصفية صارمة:** يجب أن تكون جميع البيانات المرجعية من **الشقق السكنية فقط** — لا فلل، لا تاون هاوس، لا فيلات
...
🚨 **قواعد إلزامية - استخدمي البيانات الحقيقية فقط:**
- **قاعدة ذهبية:** استخدمي أسماء المباني من Google Maps أعلاه فقط - لا تخترعي أسماء جديدة
- المباني المذكورة أعلاه هي الوحيدة المسموحة - لا أسماء أخرى
- إذا كان عدد المباني أقل من 10، استخدمي جميع المباني الموجودة فقط
- لا تخلطي بين أسعار الفلل وأسعار الشقق — نحن نبني مبنى شقق سكنية فقط
- لكل مبنى: اسم حقيقي من Google Maps + تقديرات مهنية للأسعار
- التقديرات تُعلّم بـ "تقدير مهني"
- **ملاحظة حاسمة:** المباني المذكورة أعلاه من Google Maps هي المرجع الوحيد - لا تخترعي أسماء أخرى مهما كانت الأسباب
