...
// Cost breakdown — exact items and order from projectCostsCalc.ts
const COST_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      { name: "أتعاب التصاميم (1.8%)", amount: 6_300_000 },
      { name: "أتعاب الإشراف (2%)", amount: 7_000_000 },
  ...
  },
  {
    category: "الإنشاء",
    items: [
      { name: "تكلفة الإنشاء (400 د.إ/قدم²)", amount: 350_000_000 },
      { name: "رسوم المجتمع", amount: 2_000_000 },
      { name: "احتياطي طوارئ (2%)", amount: 7_000_000 },
    ],
  },
  {
    category: "المبيعات والتسويق",
    items: [
      { name: "أتعاب المطور (5%)", amount: 31_125_000 },
      { name: "عمولة المبيعات (5%)", amount: 31_125_000 },
      { name: "ميزانية التسويق (2%)", amount: 12_450_000 },
    ],
  },
  {
    category: "الرسوم التنظيمية (ريرا)",
    items: [
      ...
      { name: "رسوم المساح", amount: 45_000 },
