...
const monthlySource = readFileSync("client/src/pages/V2PortfolioMonthly.tsx", "utf8");
...
describe("Financial Studies visual system", () => {
  ...
  it("uses compact, gridded tables with explicit total treatments", () => {
    ...
    expect(monthlySource).toContain("w-max min-w-[660px]");
    expect(monthlySource).toContain("border-r-2 border-slate-400");
