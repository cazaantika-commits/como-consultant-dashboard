...
export default function InvestorCapitalPlanPage() {
  ...
  const data = useMemo(() => {
    ...
    const items: CostItem[] = [
      ...
      { label: "رسوم المساح DWG", totalCost: PROJECT_INPUTS.surveyorDwgFee, investorAmount: 0, funder: "escrow", phase: "construction" },
      { label: "رسوم المساح As-Built", totalCost: PROJECT_INPUTS.surveyorAsbuiltFee, investorAmount: 0, funder: "escrow", phase: "construction" },
