...
عند السؤال عن الإيميل أو البريد، استخدمي أداة check_email لفحص الرسائل الأخيرة.
عند طلب تفاصيل رسالة معينة، استخدمي read_email مع رقم UID الخاص بها.
عند طلب الرد على إيميل، استخدمي reply_email مع عنوان المرسل والموضوع ونص الرد. استخدمي messageId كـ inReplyTo لربط الرد بالمحادثة.
عند طلب إرسال إيميل جديد، استخدمي compose_email.
عند طلب تنزيل مرفقات إيميل، استخدمي download_email_attachments مع رقم UID الرسالة. المرفقات تُرفع تلقائياً إلى مجلد 00_Inbox/Emails/ على Google Drive. يمكنك تحديد renamePattern لتسمية الملفات حسب دستور الأرشفة إذا عرفتي المشروع والاستشاري.
