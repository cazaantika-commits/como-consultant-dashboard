...
- [x] Validate every timing business rule with the user before auditing its reflected cash-flow dates
- [x] Verify the project-relative timing formulas across projects with different design-stage durations
...
- [x] Preserve the completed Project Aggregation report unchanged; no additional modifications are currently requested
...
- [x] Restore Timeline visibility for the villa build-for-sale project and verify its saved design-stage duration propagates to Sales, Investor Cash Flow, Feasibility, and Timeline
...
- [x] Save the approved 17-week villa design-stage allocation as four months and verify its propagation across Financial Studies
- [x] Correct the build-for-sale Timeline direct-sales bar so it uses the saved post-completion Sales Plan months rather than off-plan distribution months
- [x] Hide Off-Plan-only investor payment, RERA, and escrow rules from Settings & Rules for build-for-sale projects
...
- [x] Add the approved darker readable text contrast rule to the project-wide visual language
...
- [x] Remove unused vertical space by converting Sales and Construction month cards into ultra-compact horizontal strips
- [x] Replace the current unit-pricing card grid with a wholly different compact pricing-workspace composition while keeping price-only editing
