...
const CRITERIA = [
  {
    ...
    weight: 20,
    options: [
      { score: 0, label: "0 نقاط: لا توجد خبرة أو مؤهلات واضحة" },
      { score: 10, label: "10 نقاط: خبرة محدودة أو مؤهلات أساسية" },
      { score: 15, label: "15 نقاط: خبرة جيدة ومؤهلات مناسبة" },
      { score: 20, label: "20 نقاط: خبرة واسعة ومؤهلات متميزة" },
    ],
  },
  {
    id: 2,
    name: "جودة العمل السابق",
    weight: 25,
    options: [
      { score: 0, label: "0 نقاط: لا توجد أعمال سابقة أو جودة ضعيفة" },
      { score: 12, label: "12 نقاط: أعمال سابقة بجودة مقبولة" },
      { score: 18, label: "18 نقاط: أعمال سابقة بجودة جيدة" },
      { score: 25, label: "25 نقاط: أعمال سابقة بجودة ممتازة" },
    ],
  },
  {
    id: 3,
    name: "الفريق والموارد",
    weight: 15,
    options: [
      { score: 0, label: "0 نقاط: فريق غير كافٍ أو موارد محدودة" },
      { score: 7, label: "7 نقاط: فريق مناسب وموارد كافية" },
      { score: 11, label: "11 نقاط: فريق قوي وموارد جيدة" },
      { score: 15, label: "15 نقاط: فريق متميز وموارد ممتازة" },
    ],
  },
  {
    id: 4,
    ...
    weight: 15,
    options: [
      { score: 0, label: "0 نقاط: سجل ضعيف في الالتزام بالمواعيد" },
      { score: 7, label: "7 نقاط: التزام مقبول بالمواعيد" },
      { score: 11, label: "11 نقاط: التزام جيد بالمواعيد" },
      { score: 15, label: "15 نقاط: التزام ممتاز بالمواعيد" },
    ],
  },
  {
    id: 5,
    ...
    weight: 10,
    options: [
      { score: 0, label: "0 نقاط: تواصل ضعيف وتعاون محدود" },
      { score: 5, label: "5 نقاط: تواصل مقبول وتعاون جيد" },
      { score: 7, label: "7 نقاط: تواصل جيد وتعاون ممتاز" },
      { score: 10, label: "10 نقاط: تواصل ممتاز وتعاون استثنائي" },
    ],
  },
  {
    id: 6,
    ...
    weight: 15,
    options: [
      { score: 0, label: "0 نقاط: لا يوجد ابتكار أو إبداع" },
      { score: 7, label: "7 نقاط: ابتكار محدود" },
      { score: 11, label: "11 نقاط: ابتكار جيد" },
      { score: 15, label: "15 نقاط: ابتكار وإبداع متميز" },
    ],
  },
];
