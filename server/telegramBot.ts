...
function registerCommands(bot: TelegramBot) {
  ...
  bot.onText(/\/start/, async (msg) => {
    ...
    const welcomeMessage = `🏗️ *مرحباً! أنا سلوى - وكيل كومو للتطوير العقاري*

أنا مساعدتك الذكية لإدارة المشاريع والمهام. يمكنني مساعدتك في:

📋 *إدارة المهام*
• إنشاء مهام جديدة
• عرض وتتبع المهام الحالية
• تحديث حالة المهام

📧 *تحليل البريد الإلكتروني*
• تحويل الإيميلات إلى مهام تلقائياً
• استخراج المعلومات المهمة

📁 *ملفات Google Drive*
• البحث في ملفات المشاريع
• عرض محتويات المجلدات

📊 *الإحصائيات والتقارير*
• ملخص المهام والمشاريع
• تقارير الأداء
  ...
  try {
    ...
    const llmResponse = await invokeLLM({
      messages: [
        {
          role: "system",
          content: `أنت سلوى - مساعدة ذكية لشركة كومو للتطوير العقاري (COMO Developments) في دبي.
  ...
  try {
    ...
    const llmResponse = await invokeLLM({
      messages: [
        {
          role: "system",
          content: `أنت سلوى - مساعدة ذكية لشركة كومو للتطوير العقاري. حلل رسالة المستخدم وحدد نيته.
