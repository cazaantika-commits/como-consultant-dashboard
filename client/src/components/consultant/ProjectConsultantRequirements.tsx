...
export function ProjectConsultantRequirements({ projectId, projectName, onBack }: { projectId: number; projectName: string; onBack: () => void }) {
  ...
  const isArticBaseline = String(set?.notes ?? "").startsWith("ARTEC_SCOPE_BASELINE_V1");
  useEffect(() => {
