...
const EMPTY_FORM: EvidenceForm = {
  evidenceType: "comparable", sourceType: "DLD", sourceName: "", sourceUrl: "", sourceDate: "", confidenceGrade: "high",
  comparableName: "", community: "", assetClass: "residential", unitType: "", unitAreaSqft: "", pricePerSqft: "", transactionValue: "", paymentPlanSummary: "", notes: "",
};
...
export default function MarketEvidencePanel({ projectId, decisionSnapshot }: { projectId: number; decisionSnapshot: Record<string, unknown> }) {
  ...
  const submitEvidence = (event: React.FormEvent) => {
    ...
    addEvidence.mutate({
      projectId, evidenceType: form.evidenceType, sourceType: form.sourceType, sourceName: form.sourceName, sourceUrl: form.sourceUrl,
      ...
      assetClass: form.assetClass, unitType: form.unitType, unitAreaSqft: numberOrUndefined(form.unitAreaSqft), pricePerSqft: numberOrUndefined(form.pricePerSqft),
