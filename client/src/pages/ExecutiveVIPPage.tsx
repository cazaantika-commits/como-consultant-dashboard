  ...
  const renderCashFlow = () => (
    <SubPage title="التدفقات النقدية" icon={<DollarSign className="w-6 h-6" />} color="bg-gradient-to-r from-green-500 to-emerald-600" onBack={() => setActiveSection(null)}>
      <Card className="p-6 text-center">
        ...
        <button onClick={() => navigate("/bateekha")} className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-2 rounded-full text-sm font-medium hover:shadow-lg transition-all">
